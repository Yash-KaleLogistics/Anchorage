...
class AirlineMainPage extends StatefulWidget {
  const AirlineMainPage({super.key});

  @override
  State<AirlineMainPage> createState() => _AirlineMainPageState();
}

class _AirlineMainPageState extends State<AirlineMainPage> {
  int selected = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(context, CupertinoPageRoute(builder: (context) => AirlineCreateScreen(),));
        },
        backgroundColor: Colors.white,
        child: Icon(
          CupertinoIcons.add,
